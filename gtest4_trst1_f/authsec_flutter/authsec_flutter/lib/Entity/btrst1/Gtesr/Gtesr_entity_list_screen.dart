...
import 'package:authsec_flutter/Entity/btrst1/Gtesr/Gtesr_create_entity_screen.dart';
import 'package:authsec_flutter/Entity/btrst1/Gtesr/Gtesr_update_entity_screen.dart';
import 'package:authsec_flutter/providers/token_manager.dart';
import 'package:flutter/services.dart';

class gtesr_entity_list_screen extends StatefulWidget {
  static const String routeName = '/entity-list';

  @override
  _gtesr_entity_list_screenState createState() => _gtesr_entity_list_screenState();
}

class _gtesr_entity_list_screenState extends State<gtesr_entity_list_screen> {
 ...
 Text(entity['collge'] ?? 'No collge provided'),
